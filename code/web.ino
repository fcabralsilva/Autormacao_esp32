...
String pagina() {
  ...
  */
  ...
  buf += "</form> ";
  buf += "</div> </div>";
  buf += "<a href=\"http://" + ipLocalString + "\"><p style=\"text-align:center\"><p style=\"text-align:right\"> <span class=\"badge badge-pill badge-primary\">MAC:" + addressMac + " SSID: " + WiFi.SSID() + " " + VERSAO + "</span></span></a></p>";
